...
def submit_data():
    ...
    sql=f"""INSERT INTO USERINFORMATION (FIRST_NAME, LAST_NAME, TITLE, AGE, NATIONALITY, NOOFCOURSES, NOOFSEM, REGISTRATION_STATUS ) VALUES 
    ('{first_name}','{last_name}','{title}','{age}','{nationality}','{num_courses}','{num_semesters}','{registration_status}')"""
